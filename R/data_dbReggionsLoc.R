...
#' @rdname dbRegionsLoc
#' @name dbRegionsLoc
#' @aliases dbRegionsLoc_hg19 dbRegionsLoc_mm9
#' @title Genomic location for the database regions
#' @description 
#' \itemize{
#' \item{\bold{dbRegionsLoc_hg19}: }{Contains the location for \bold{HUMAN} regions 
...
#'   
#' \item{\bold{dbRegionsLoc_mm9}: }{Contains the location for \bold{MOUSE} regions 
