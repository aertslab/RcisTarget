...
To analyze the gene list, RcisTarget needs two types of databases: - 1.
...
If you don't know which database to choose, for an analisis of a gene list we would suggest using the *500bp upstream TSS*, and a larger search space (e.g. *TSS+/-5kbp* or *TSS+/-10kbp*) with 7 species.
