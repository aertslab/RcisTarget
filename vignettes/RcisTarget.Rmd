...
> Note for **development** version: The **database** packages are still not included in Bioconductor. They can be downloaded from http://scenic.aertslab.org
...
If you use RcisTarget in your research, please cite: *(TO DO: Update publication)*
...
Species | Package
------- | -----
Human (hg19) | [SCENIC.hg19.motifDatabases.20k](http://scenic.aertslab.org/downloads/databases/RcisTarget.hg19.motifDatabases.20k_0.1.1.tar.gz)
Mouse (mm9)  | [SCENIC.mm9.motifDatabases.20k](http://scenic.aertslab.org/downloads/databases/RcisTarget.mm9.motifDatabases.20k_0.1.1.tar.gz)
Drosophila melanogaster (dm6)  | [SCENIC.dm6.motifDatabases.20k](http://scenic.aertslab.org/downloads/databases/RcisTarget.dm6.motifDatabases.20k_0.2.1.tar.gz)

<!-- Human (hg19) | `r Biocpkg("SCENIC.hg19.motifDatabases.20k")` -->
<!-- Mouse (mm9)  | `r Biocpkg("SCENIC.mm9.motifDatabases.20k")` -->
<!-- Mouse (mm9)  | `r Biocpkg("SCENIC.dm6.motifDatabases.20k")` -->
