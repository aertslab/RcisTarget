...
The list of all available databases is at https://resources.aertslab.org/cistarget/ (alternative mirror: https://resources-mirror.aertslab.org/cistarget/). Each database is stored in a `.feather` file. Note that the download size is typically over 1GB (100GB for human region databases), we recommend downloading the files with zsync_curl 
(see the [Help with downloads](https://resources.aertslab.org/cistarget/help.html)).
