...
hist(motifs_AUC@AUC["hypoxia",], main="hypoxia", xlab="AUC histogram",
     breaks=100, col="#ff000050", border="darkred")
nes3 <- (3*sd(motifs_AUC@AUC["hypoxia",])) + mean(motifs_AUC@AUC["hypoxia",])
...
library(DT)
datatable(motifEnrichmentTable_wGenes_wLogo[,-c("enrichedGenes", "TF_indirect"), with=FALSE], 
