...
------- | ----- | ----- | -----
Human | hg19 | Full version (recommended) | [SCENIC.hg19.motifDBs.20k](http://scenic.aertslab.org/downloads/databases/RcisTarget.hg19.motifDBs.20k_0.2.0.tar.gz)
Human | hg19 | Subset | - available soon: *RcisTarget.hg19.motifDBs.cisbpOnly.500bp*
Mouse | mm9 | Full version (recommended) | [SCENIC.mm9.motifDBs.20k](http://scenic.aertslab.org/downloads/databases/RcisTarget.mm9.motifDBs.20k_0.2.0.tar.gz)
...
anotatedTfs <- lapply(split(motifEnrichmentTable_wGenes$TF_direct,
